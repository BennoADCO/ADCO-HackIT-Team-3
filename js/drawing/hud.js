/* ==========================================================================
   ...
   The top bar shows the day, the clock, Biscuit's health and how many
   grooms you've done today. The bottom bar always tells you what to do
   next. Also the message bubble.
   ========================================================================== */
...
function drawHud() {
  ...
  /* Biscuit's health as a number, and today's grooms. */
  var friend = followerCat();
  if (friend) {
    drawHudChip('💚', friend.name + '  ' + Math.round(friend.health), 400,
                CONFIG.CAT_HEALTH_BAR_COLOUR);
  }
  drawHudChip('🐾', 'Grooms today  ' + state.dayStats.grooms, 640, '#ffd24a');
